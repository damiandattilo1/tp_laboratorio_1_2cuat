 ...
 * \param funcion que sabe filtrar el elemento, devuelve 1 si el elemento es devuelto en la lista, o 0 si no
...
LinkedList* ll_map(LinkedList* this, void*(pFunc)(void*element))
{
    ...
    if(this!=NULL)
    {
        for(int i=0; i<tam;i++)
        {
            ...
            if(auxPais!=NULL)
            {
                auxPais2=(pFunc)(auxPais);
                ll_add(nuevaLista, auxPais2);
            }
        }
    }
    return nuevaLista;
